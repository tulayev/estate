    ...
    <div class="mini-container">
        ...
        >
            ...
            <div class="relative z-10">
                <h2 class="section-title-white text-lg sm:text-2xl xl:text-5xl">The Problem We Solve</h2>
                <p class="text-white text-sm xl:text-base xl:text-2xl mt-4 sm:mt-5 lg:mt-10">
